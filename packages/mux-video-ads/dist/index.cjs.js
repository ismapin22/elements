...
var import_mux_video = __toESM(require("@mux/mux-video"));
var import_mux_data_google_ima = __toESM(require("@mux/mux-data-google-ima"));
...
var MuxVideoAds = class extends import_mux_video.default {
  constructor() {
    super();
  ...
  get muxDataSDK() {
    return import_mux_data_google_ima.default;
  }
