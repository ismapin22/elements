...
function createComponent({
  ...
  const IS_REACT_19_OR_NEWER2 = Number.parseInt(React8.version) >= 19;
  const ReactComponent = React8.forwardRef((props, ref) => {
    var _a2, _b, _c, _d, _e;
    const elementRef = React8.useRef(null);
    const prevElemPropsRef = React8.useRef(/* @__PURE__ */ new Map());
    const eventProps = {};
    const attrs = {};
    const reactProps = {};
    const elementProps = {};
    for (const [k, v] of Object.entries(props)) {
      ...
      const attrName = toAttributeName((_a2 = reactPropToAttrNameMap[k]) != null ? _a2 : k);
      ...
      if (attrName && attrValue != null) {
        ...
        if (!IS_REACT_19_OR_NEWER2) {
          reactProps[attrName] = attrValue;
        }
      }
      if (attrName && IS_REACT_19_OR_NEWER2) {
    ...
    if (typeof window === "undefined" && (elementClass == null ? void 0 : elementClass.getTemplateHTML) && (elementClass == null ? void 0 : elementClass.shadowRootOptions)) {
      ...
      const templateShadowRoot = React8.createElement("template", {
        shadowrootmode: mode,
    ...
    return React8.createElement(tagName, {
      ...reactProps,
      ref: React8.useCallback(
        (node) => {
...
function setProperty(node, name, value) {
  var _a2, _b;
  node[name] = value;
  if (value == null && name in ((_b = (_a2 = globalThis.HTMLElement) == null ? void 0 : _a2.prototype) != null ? _b : {})) {
...
var getBrowserLanguage = () => {
  var _a2;
  return ((_a2 = globalThis.navigator) == null ? void 0 : _a2.language.split("-")[0]) || "en";
};
var t = (key, variables = {}) => {
  var _a2;
  const result = ((_a2 = translationsLanguages[getBrowserLanguage()]) == null ? void 0 : _a2[key]) || En[key];
  ...
  constructor(options = {}) {
    ...
    if (!this.shadowRoot) {
      ...
      if (options.tooltipContent) {
        buttonHTML.querySelector('slot[name="tooltip-content"]').innerHTML = (_a2 = options.tooltipContent) != null ? _a2 : "";
...
var MediaChromeMenu = class extends GlobalThis.HTMLElement {
  constructor() {
    super();
    __privateAdd20(this, _handleSlotChange);
    __privateAdd20(this, _updateLayoutStyle);
    __privateAdd20(this, _handleInvoke2);
    __privateAdd20(this, _handleOpen2);
    __privateAdd20(this, _handleClosed2);
    __privateAdd20(this, _positionMenu);
    __privateAdd20(this, _resizeMenu);
    __privateAdd20(this, _handleClick);
    __privateAdd20(this, _backButtonElement);
    __privateAdd20(this, _handleToggle);
    __privateAdd20(this, _checkSubmenuHasExpanded);
    __privateAdd20(this, _handleFocusOut2);
    __privateAdd20(this, _handleKeyDown2);
    __privateAdd20(this, _getItem);
    __privateAdd20(this, _getTabItem);
    __privateAdd20(this, _setTabItem);
    __privateAdd20(this, _selectItem);
    __privateAdd20(this, _mediaController8, null);
    __privateAdd20(this, _previouslyFocused2, null);
    __privateAdd20(this, _invokerElement2, null);
    __privateAdd20(this, _previousItems, /* @__PURE__ */ new Set());
    __privateAdd20(this, _mutationObserver2, void 0);
    __privateAdd20(this, _isPopover, false);
    __privateAdd20(this, _cssRule, null);
    __privateAdd20(this, _handleMenuItems, () => {
      const previousItems = __privateGet20(this, _previousItems);
      ...
      __privateSet19(this, _previousItems, currentItems);
    });
    __privateAdd20(this, _handleBoundsResize, () => {
      __privateMethod7(this, _positionMenu, positionMenu_fn).call(this);
      __privateMethod7(this, _resizeMenu, resizeMenu_fn).call(this, false);
    });
    __privateAdd20(this, _handleMenuResize, () => {
      __privateMethod7(this, _positionMenu, positionMenu_fn).call(this);
    });
    if (!this.shadowRoot) {
      this.attachShadow({ mode: "open" });
    ...
    __privateSet19(this, _mutationObserver2, new MutationObserver(__privateGet20(this, _handleMenuItems)));
    __privateGet20(this, _mutationObserver2).observe(this.defaultSlot, { childList: true });
  }
  static get observedAttributes() {
    return [
  ...
  connectedCallback() {
    var _a2, _b;
    __privateSet19(this, _cssRule, insertCSSRule(this.shadowRoot, ":host"));
    ...
    __privateSet19(this, _mediaController8, getAttributeMediaController(this));
    (_b = (_a2 = __privateGet20(this, _mediaController8)) == null ? void 0 : _a2.associateElement) == null ? void 0 : _b.call(_a2, this);
    if (!this.hidden) {
      observeResize(getBoundsElement(this), __privateGet20(this, _handleBoundsResize));
      observeResize(this, __privateGet20(this, _handleMenuResize));
    }
  }
  disconnectedCallback() {
    var _a2, _b;
    unobserveResize(getBoundsElement(this), __privateGet20(this, _handleBoundsResize));
    unobserveResize(this, __privateGet20(this, _handleMenuResize));
    this.disable();
    (_b = (_a2 = __privateGet20(this, _mediaController8)) == null ? void 0 : _a2.unassociateElement) == null ? void 0 : _b.call(_a2, this);
    __privateSet19(this, _mediaController8, null);
  }
  attributeChangedCallback(attrName, oldValue, newValue) {
    var _a2, _b, _c, _d;
    if (attrName === Attributes12.HIDDEN && newValue !== oldValue) {
      if (!__privateGet20(this, _isPopover))
        __privateSet19(this, _isPopover, true);
      if (this.hidden) {
      ...
      if (newValue && this.isConnected) {
        __privateSet19(this, _mediaController8, getAttributeMediaController(this));
        (_d = (_c = __privateGet20(this, _mediaController8)) == null ? void 0 : _c.associateElement) == null ? void 0 : _d.call(_c, this);
      }
  ...
  focus() {
    __privateSet19(this, _previouslyFocused2, getActiveElement());
  ...
  handleSelect(event) {
    ...
    if (__privateGet20(this, _invokerElement2) && !this.hidden) {
      (_a2 = __privateGet20(this, _previouslyFocused2)) == null ? void 0 : _a2.focus();
      this.hidden = true;
    }
  }
  get keysUsed() {
  ...
  handleMove(event) {
    ...
    const currentItem = (_b = (_a2 = __privateMethod7(this, _getItem, getItem_fn).call(this, event)) != null ? _a2 : __privateMethod7(this, _getTabItem, getTabItem_fn).call(this)) != null ? _b : items[0];
...
handleSlotChange_fn = function(event) {
  ...
  if (!slot.name) {
    __privateGet20(this, _handleMenuItems).call(this);
  }
};
...
handleInvoke_fn2 = function(event) {
  __privateSet19(this, _invokerElement2, event.relatedTarget);
  if (!containsComposedNode(this, event.relatedTarget)) {
...
handleOpen_fn2 = function() {
  var _a2;
  (_a2 = __privateGet20(this, _invokerElement2)) == null ? void 0 : _a2.setAttribute("aria-expanded", "true");
  this.addEventListener("transitionend", () => this.focus(), { once: true });
  observeResize(getBoundsElement(this), __privateGet20(this, _handleBoundsResize));
  observeResize(this, __privateGet20(this, _handleMenuResize));
};
...
handleClosed_fn2 = function() {
  var _a2;
  (_a2 = __privateGet20(this, _invokerElement2)) == null ? void 0 : _a2.setAttribute("aria-expanded", "false");
  unobserveResize(getBoundsElement(this), __privateGet20(this, _handleBoundsResize));
  unobserveResize(this, __privateGet20(this, _handleMenuResize));
};
...
positionMenu_fn = function(menuWidth) {
  ...
  const { style } = __privateGet20(this, _cssRule);
...
resizeMenu_fn = function(animate) {
  ...
  if (expandedSubmenu) {
    ...
    __privateMethod7(this, _positionMenu, positionMenu_fn).call(this, width);
  } else {
...
handleClick_fn = function(event) {
  var _a2;
  event.stopPropagation();
  if (event.composedPath().includes(__privateGet20(this, _backButtonElement, backButtonElement_get))) {
    (_a2 = __privateGet20(this, _previouslyFocused2)) == null ? void 0 : _a2.focus();
    this.hidden = true;
    return;
  }
...
handleFocusOut_fn2 = function(event) {
  ...
  if (!containsComposedNode(this, event.relatedTarget)) {
    ...
    if (__privateGet20(this, _invokerElement2) && __privateGet20(this, _invokerElement2) !== event.relatedTarget && !this.hidden) {
      this.hidden = true;
    }
  }
};
...
handleKeyDown_fn2 = function(event) {
  ...
  if (key === "Tab") {
    ...
    (_e = __privateGet20(this, _previouslyFocused2)) == null ? void 0 : _e.focus();
    if (__privateGet20(this, _isPopover)) {
      this.hidden = true;
    }
...
var MediaChromeMenuItem = class extends GlobalThis.HTMLElement {
  constructor() {
    super();
    __privateAdd21(this, _handleSlotChange2);
    __privateAdd21(this, _submenuConnected);
    __privateAdd21(this, _submenuDisconnected);
    __privateAdd21(this, _handleKeyUp);
    __privateAdd21(this, _handleKeyDown3);
    __privateAdd21(this, _reset);
    __privateAdd21(this, _dirty, false);
    __privateAdd21(this, _ownerElement, void 0);
    __privateAdd21(this, _handleMenuItem, () => {
      var _a2, _b;
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    if (attrName === Attributes13.CHECKED && isCheckable(this) && !__privateGet21(this, _dirty)) {
  ...
  connectedCallback() {
    ...
    __privateSet20(this, _ownerElement, closestMenuItemsContainer(this, this.parentNode));
    __privateMethod8(this, _reset, reset_fn).call(this);
  }
  disconnectedCallback() {
    this.disable();
    __privateMethod8(this, _reset, reset_fn).call(this);
    __privateSet20(this, _ownerElement, null);
  }
  get invokeTarget() {
  ...
  get type() {
    var _a2;
    return (_a2 = this.getAttribute(Attributes13.TYPE)) != null ? _a2 : "";
  }
  set type(val) {
  ...
  get value() {
    var _a2;
    return (_a2 = this.getAttribute(Attributes13.VALUE)) != null ? _a2 : this.text;
  }
  set value(val) {
  ...
  set checked(value) {
    if (!isCheckable(this))
      return;
    __privateSet20(this, _dirty, true);
...
submenuConnected_fn = async function() {
  ...
  this.submenuElement.addEventListener("change", __privateGet21(this, _handleMenuItem));
  this.submenuElement.addEventListener("addmenuitem", __privateGet21(this, _handleMenuItem));
  this.submenuElement.addEventListener(
    "removemenuitem",
    __privateGet21(this, _handleMenuItem)
  );
  __privateGet21(this, _handleMenuItem).call(this);
};
_submenuDisconnected = /* @__PURE__ */ new WeakSet();
submenuDisconnected_fn = function() {
  this.removeAttribute("aria-haspopup");
  this.removeAttribute("aria-expanded");
  this.submenuElement.removeEventListener("change", __privateGet21(this, _handleMenuItem));
...
reset_fn = function() {
  var _a2;
  const items = (_a2 = __privateGet21(this, _ownerElement)) == null ? void 0 : _a2.radioGroupItems;
  if (!items)
    return;
...
var MediaAudioTrackMenu = class extends MediaChromeMenu {
  constructor() {
    super(...arguments);
    __privateAdd22(this, _render);
    __privateAdd22(this, _onChange);
    __privateAdd22(this, _audioTrackList, []);
    __privateAdd22(this, _prevState, void 0);
  }
  static get observedAttributes() {
    return [
      ...super.observedAttributes,
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === MediaUIAttributes.MEDIA_AUDIO_TRACK_ENABLED && oldValue !== newValue) {
      ...
      __privateSet21(this, _audioTrackList, parseAudioTrackList(newValue != null ? newValue : ""));
  ...
  get mediaAudioTrackList() {
    return __privateGet22(this, _audioTrackList);
  }
  set mediaAudioTrackList(list) {
    __privateSet21(this, _audioTrackList, list);
    __privateMethod9(this, _render, render_fn).call(this);
  }
  /**
...
render_fn = function() {
  if (__privateGet22(this, _prevState) === JSON.stringify(this.mediaAudioTrackList))
    return;
  __privateSet21(this, _prevState, JSON.stringify(this.mediaAudioTrackList));
...
var MediaCaptionsMenu = class extends MediaChromeMenu {
  constructor() {
    super(...arguments);
    __privateAdd23(this, _render2);
    __privateAdd23(this, _onChange2);
    __privateAdd23(this, _prevState2, void 0);
  }
  static get observedAttributes() {
    return [
      ...super.observedAttributes,
...
render_fn2 = function() {
  var _a2;
  if (__privateGet23(this, _prevState2) === JSON.stringify(this.mediaSubtitlesList))
    return;
  __privateSet22(this, _prevState2, JSON.stringify(this.mediaSubtitlesList));
  this.defaultSlot.textContent = "";
...
var MediaCaptionsMenuButton = class extends MediaChromeMenuButton {
  constructor(options = {}) {
    ...
    __privateAdd24(this, _captionsReady, void 0);
    __privateSet23(this, _captionsReady, false);
  }
  static get observedAttributes() {
    return [
      ...super.observedAttributes,
...
var MediaPlaybackRateMenu = class extends MediaChromeMenu {
  constructor() {
    super();
    __privateAdd25(this, _render3);
    __privateAdd25(this, _onChange3);
    __privateAdd25(this, _rates2, new AttributeTokenList(this, Attributes14.RATES, {
      defaultValue: DEFAULT_RATES
    }));
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === MediaUIAttributes.MEDIA_PLAYBACK_RATE && oldValue != newValue) {
      ...
      __privateGet24(this, _rates2).value = newValue;
      __privateMethod11(this, _render3, render_fn3).call(this);
    }
  }
  connectedCallback() {
   ...
   */
  get rates() {
    return __privateGet24(this, _rates2);
  }
  set rates(value) {
    if (!value) {
      __privateGet24(this, _rates2).value = "";
    } else if (Array.isArray(value)) {
      __privateGet24(this, _rates2).value = value.join(" ");
    }
    __privateMethod11(this, _render3, render_fn3).call(this);
  }
  /**
...
var MediaPlaybackRateMenuButton = class extends MediaChromeMenuButton {
  constructor(options = {}) {
    ...
    __privateAdd26(this, _rates3, new AttributeTokenList(this, Attributes15.RATES, {
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === Attributes15.RATES) {
      __privateGet25(this, _rates3).value = newValue;
    }
    if (attrName === MediaUIAttributes.MEDIA_PLAYBACK_RATE) {
      const newPlaybackRate = newValue ? +newValue : Number.NaN;
   ...
   */
  get rates() {
    return __privateGet25(this, _rates3);
  }
  set rates(value) {
    if (!value) {
      __privateGet25(this, _rates3).value = "";
    } else if (Array.isArray(value)) {
      __privateGet25(this, _rates3).value = value.join(" ");
    }
  }
  /**
   * The current playback rate
...
var MediaRenditionMenu = class extends MediaChromeMenu {
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (attrName === MediaUIAttributes.MEDIA_RENDITION_SELECTED && oldValue !== newValue) {
      ...
      __privateSet24(this, _renditionList, parseRenditionList(newValue));
      __privateMethod12(this, _render4, render_fn4).call(this);
  ...
  get mediaRenditionList() {
    return __privateGet26(this, _renditionList);
  }
  set mediaRenditionList(list) {
    __privateSet24(this, _renditionList, list);
    __privateMethod12(this, _render4, render_fn4).call(this);
  }
  /**
...
render_fn4 = function() {
  if (__privateGet26(this, _prevState3).mediaRenditionList === JSON.stringify(this.mediaRenditionList) && __privateGet26(this, _prevState3).mediaHeight === this.mediaHeight)
    return;
  __privateGet26(this, _prevState3).mediaRenditionList = JSON.stringify(this.mediaRenditionList);
  __privateGet26(this, _prevState3).mediaHeight = this.mediaHeight;
...
var Playlist = ({ videoList }) => {
  ...
  return /* @__PURE__ */ React6.createElement("div", null, /* @__PURE__ */ React6.createElement(NewsweekTheme, null), /* @__PURE__ */ React6.createElement(
    ...
    /* @__PURE__ */ React6.createElement(playlist_end_screen_default, { video: currentIndex < videoList.length - 1 ? videoList[currentIndex + 1] : videoList[0], relatedVideos: videoList, isVisible: isEndScreenVisible, selectVideoCallback: selectVideo, timerCallback: playVideo })
  ));
};
...
ce-la-react/dist/ce-la-react.js:
   ...
   *)
*/
//# sourceMappingURL=-CNSRT7EO.mjs.map
